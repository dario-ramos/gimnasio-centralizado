...
main (int argc, char **argv)
{
	...
	pmap_unset (SERVIDOR_IDS_PROG, SERVIDOR_IDS_VERS);
	...
	if (!svc_register(transp, SERVIDOR_IDS_PROG, SERVIDOR_IDS_VERS, servidor_ids_prog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (SERVIDOR_IDS_PROG, SERVIDOR_IDS_VERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, SERVIDOR_IDS_PROG, SERVIDOR_IDS_VERS, servidor_ids_prog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (SERVIDOR_IDS_PROG, SERVIDOR_IDS_VERS, tcp).");
		exit(1);
	}
